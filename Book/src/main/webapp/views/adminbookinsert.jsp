			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link active"
						 ...
						 <li class="nav-item"><a class="nav-link active"
						 href="/admin">Menu</a></li>

				</ul>
			</div>
		</div>
	</nav>
	<form action="/admin/insertbook" method="post" style="height:100vh;">
					...
					<div class="col-lg-8 col-xl-6">
						<div class="card rounded-3">
							<div class="card-body p-4 p-md-5">
								<h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Enter the Details
									Info</h3>

								<form class="px-md-2">

									<div class="form-outline mb-4">
										<input type="text" id="form3Example1q" class="form-control" name="bookName"/>
										<label class="form-label" for="form3Example1q">Book Name</label>
									</div>
									
									<div class="form-outline mb-4">
										<input type="text" id="form3Example1q" class="form-control" name="authorName"/>
